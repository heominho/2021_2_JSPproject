...
<header>실시간 순위입니다! 곡 제목과 가수, 앨범을 클릭하면 각각의 정보를 볼 수 있습니다! 노래는 음소거를 해제해서 들어주세요!</header>
...
<table class="type09">
    ...
    <tr>
        <th scope="row">4위</th>
        <td>
        	<a href="https://vibe.naver.com/track/51082248">strawberry moon</a>
        </td>
        <td>
        	<a href="https://vibe.naver.com/artist/112579">아이유(IU)</a>
        </td>
        <td>
			락
        </td>
        <td>
        	<a href="https://vibe.naver.com/album/6520837">strawberry moon</a>
        </td>
        <td>
        	<iframe src="https://www.youtube.com/embed/sqgxcCjD04s?" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </td>
    </tr>
    <tr>
        <th scope="row">5위</th>
